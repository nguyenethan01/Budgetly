...
var Tab = /** @class */function (_super) {
    ...
    Tab.prototype.render = function () {
        ...
        return React.createElement(
            TabItem,
            { active: active, onMouseDown: this.handleSelectSession },
            React.createElement(
                Icons,
                { active: active },
                session.subscriptionActive && React.createElement(RedDot, null),
                React.createElement(
                    QueryTypes,
                    null,
                    ...
                    (session.isSettingsTab || session.isConfigTab) && React.createElement(
                        Query,
                        null,
                        React.createElement(Icons_1.SettingsIcon, { width: 12, height: 12, fill: "white" })
                    ),
            ...
            this.state.editingName ? React.createElement(OperationNameInput, { value: session.name || '', onChange: this.handleEditName, onBlur: this.stopEditName, onKeyDown: this.handleKeyDown, autoFocus: true }) : React.createElement(
                OperationName,
                { active: active, onDoubleClick: this.startEditName },
                name
            ),
            React.createElement(
                Close,
                { className: "close", active: active, hasCircle: session.isFile && session.changed && !this.state.overCross, onClick: this.handleCloseSession, onMouseEnter: this.handleMouseOverCross, onMouseLeave: this.handleMouseOutCross },
                session.isFile && session.changed && !this.state.overCross ? React.createElement(
                    Circle,
                    null,
                    "\u2B24"
                ) : React.createElement(Icons_1.CrossIcon, { width: 12, height: 11, strokeWidth: 7, title: "Close Tab" })
            )
        );
    };
    return Tab;
