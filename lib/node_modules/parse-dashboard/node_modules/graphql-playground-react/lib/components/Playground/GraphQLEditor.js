...
var GraphQLEditor = /** @class */function (_super) {
    ...
    GraphQLEditor.prototype.render = function () {
        return React.createElement(
            ...
            { setRef: this.setContainerComponent },
            React.createElement(
                EditorWrapper_1.default,
                null,
                React.createElement(TopBar_1.default, { shareEnabled: this.props.shareEnabled, fixedEndpoint: this.props.fixedEndpoint }),
                React.createElement(
                    EditorBar,
                    { ref: this.setEditorBarComponent, onMouseDown: this.handleResizeStart },
                    React.createElement(
                        QueryWrap,
                        { flex: this.props.editorFlex },
                        React.createElement(QueryEditor_1.default, { getRef: this.setQueryEditorComponent, schema: this.props.schema, onHintInformationRender: this.handleHintInformationRender, onRunQuery: this.runQueryAtCursor, onClickReference: this.handleClickReference }),
                        React.createElement(
                            VariableEditor,
                            { isOpen: this.props.variableEditorOpen, height: this.props.variableEditorHeight },
                            React.createElement(
                                VariableEditorTitle,
                                { isOpen: this.props.variableEditorOpen, onMouseDown: this.handleVariableResizeStart },
                                React.createElement(
                                    VariableEditorSubtitle,
                                    { isOpen: this.props.queryVariablesActive, ref: this.setQueryVariablesRef, onClick: this.props.openQueryVariables },
                                    "Query Variables"
                                ),
                                React.createElement(
                                    VariableEditorSubtitle,
                                    { isOpen: !this.props.queryVariablesActive, ref: this.setHttpHeadersRef, onClick: this.props.closeQueryVariables },
                                    'HTTP Headers ' + (this.props.headersCount && this.props.headersCount > 0 ? "(" + this.props.headersCount + ")" : '')
                                )
                            ),
                            this.props.queryVariablesActive ? React.createElement(VariableEditor_1.VariableEditorComponent, { getRef: this.setVariableEditorComponent, onHintInformationRender: this.props.queryVariablesActive ? this.handleHintInformationRender : undefined, onRunQuery: this.runQueryAtCursor }) : React.createElement(VariableEditor_1.HeadersEditorComponent, { getRef: this.setVariableEditorComponent, onHintInformationRender: this.props.queryVariablesActive ? this.handleHintInformationRender : undefined, onRunQuery: this.runQueryAtCursor })
                        ),
                    ...
                    React.createElement(
                        ...
                        React.createElement(ExecuteButton_1.default, null),
                        this.props.queryRunning && this.props.responses.size === 0 && React.createElement(Spinner_1.default, null),
                        React.createElement(Results_1.default, { setRef: this.setResultComponent }),
                        !this.props.queryRunning && (!this.props.responses || this.props.responses.size === 0) && React.createElement(
                            Intro,
                            null,
                            "Hit the Play Button to get a response here"
                        ),
                        this.props.subscriptionActive && React.createElement(
                            Listening,
                            null,
                            "Listening \u2026"
                        ),
                        React.createElement(
                            ResponseTracking,
                            { isOpen: this.props.responseTracingOpen, height: this.props.responseTracingHeight },
                            React.createElement(
                                ResponseTrackingTitle,
                                { isOpen: this.props.responseTracingOpen, onMouseDown: this.handleTracingResizeStart },
                                React.createElement(
                                    VariableEditorSubtitle,
                                    { isOpen: false },
                                    "Tracing"
                            ...
                            React.createElement(ResponseTracing_1.default, { open: this.props.responseTracingOpen })
                        )
                    )
                )
            ),
            this.containerComponent && React.createElement(
                SideTabs_1.default,
                { maxWidth: this.containerComponent.offsetWidth - 86 },
                React.createElement(
                    SideTab_1.default,
                    { label: "Docs", activeColor: "green", tabWidth: "49px" },
                    React.createElement(GraphDocs_1.default, { schema: this.props.schema, ref: this.setDocExplorerRef })
                ),
                React.createElement(
                    SideTab_1.default,
                    { label: "Schema", activeColor: "blue", tabWidth: "65px" },
                    React.createElement(SDLView_1.default, { schema: this.props.schema, ref: this.setSchemaExplorerRef, sessionId: this.props.sessionId })
                )
            )
        );
    };
    ...
    GraphQLEditor.prototype.autoCompleteLeafs = function () {
        var _a = fillLeafs_1.fillLeafs(this.props.schema, this.props.query),
...
var mapStateToProps = reselect_1.createStructuredSelector({
    ...
    responseTracingOpen: selectors_1.getResponseTracingOpen,
...
var BottomDrawer = index_1.styled('div')(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  background: #0b1924;\n  flex-direction: column;\n  position: relative;\n  height: ", ";\n"], ["\n  display: flex;\n  background: #0b1924;\n  flex-direction: column;\n  position: relative;\n  height: ", ";\n"])), function (props) {
    return props.isOpen ? props.height + "px" : '43px';
});
...
var VariableEditor = index_1.styled(BottomDrawer)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  .CodeMirror {\n    padding-left: 4px;\n    width: calc(100% - 4px);\n    background: ", ";\n  }\n  .CodeMirror-lines {\n    padding: 10px 0 20px 0;\n  }\n  .CodeMirror-linenumbers {\n    background: ", ";\n  }\n"], ["\n  .CodeMirror {\n    padding-left: 4px;\n    width: calc(100% - 4px);\n    background: ", ";\n  }\n  .CodeMirror-lines {\n    padding: 10px 0 20px 0;\n  }\n  .CodeMirror-linenumbers {\n    background: ", ";\n  }\n"])), function (p) {
    return p.theme.editorColours.leftDrawerBackground;
}, function (p) {
    return p.theme.editorColours.leftDrawerBackground;
});
var VariableEditorTitle = index_1.styled(function (_a) {
    var isOpen = _a.isOpen,
        rest = __rest(_a, ["isOpen"]);
    return React.createElement(BottomDrawerTitle, rest);
})(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  cursor: ", ";\n  background: ", ";\n"], ["\n  cursor: ", ";\n  background: ", ";\n"])), function (p) {
    return p.isOpen ? 'row-resize' : 'n-resize';
}, function (p) {
    return p.theme.editorColours.leftDrawerBackground;
});
var VariableEditorSubtitle = index_1.styled('span')(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  margin-right: 10px;\n  cursor: pointer;\n  color: ", ";\n  &:last-child {\n    margin-right: 0;\n  }\n"], ["\n  margin-right: 10px;\n  cursor: pointer;\n  color: ", ";\n  &:last-child {\n    margin-right: 0;\n  }\n"])), function (p) {
    return p.isOpen ? p.theme.editorColours.drawerText : p.theme.editorColours.drawerTextInactive;
});
var ResponseTracking = index_1.styled(BottomDrawer)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  background: ", ";\n"], ["\n  background: ", ";\n"])), function (p) {
    return p.theme.editorColours.rightDrawerBackground;
});
var ResponseTrackingTitle = index_1.styled(function (_a) {
    var isOpen = _a.isOpen,
        rest = __rest(_a, ["isOpen"]);
    return React.createElement(BottomDrawerTitle, rest);
    ...
    return props.isOpen ? 's-resize' : 'n-resize';
}, function (p) {
    return p.theme.editorColours.drawerTextInactive;
});
var QueryWrap = index_1.styled('div')(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  flex: ", " 1 0%;\n  border-top: 8px solid ", ";\n"], ["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  flex: ", " 1 0%;\n  border-top: 8px solid ", ";\n"])), function (props) {
    return props.flex;
}, function (props) {
    return props.theme.editorColours.resultBackground;
});
