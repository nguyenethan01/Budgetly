...
var Tab = /** @class */ (function (_super) {
    ...
    function Tab(props) {
        ...
        _this.startEditName = function () {
            _this.setState({ editingName: true });
        };
    ...
    Tab.prototype.render = function () {
        var _a = this.props, session = _a.session, selectedSessionId = _a.selectedSessionId;
        ...
        var name = session.name ||
            ...
            'New Tab';
        return (<TabItem active={active} onMouseDown={this.handleSelectSession}>
        <Icons active={active}>
          {session.subscriptionActive && <RedDot />}
          <QueryTypes>
            {queryTypes.query && <Query>Q</Query>}
            {(session.isSettingsTab || session.isConfigTab) && (<Query>
                <Icons_1.SettingsIcon width={12} height={12} fill="white"/>
              </Query>)}
            {queryTypes.mutation && <Mutation>M</Mutation>}
            {queryTypes.subscription && <Subscription>S</Subscription>}
          </QueryTypes>
        </Icons>
        {this.state.editingName ? (<OperationNameInput value={session.name || ''} onChange={this.handleEditName} onBlur={this.stopEditName} onKeyDown={this.handleKeyDown} autoFocus={true}/>) : (<OperationName active={active} onDoubleClick={this.startEditName}>
            {name}
          </OperationName>)}
        <Close className="close" active={active} hasCircle={session.isFile && session.changed && !this.state.overCross} onClick={this.handleCloseSession} onMouseEnter={this.handleMouseOverCross} onMouseLeave={this.handleMouseOutCross}>
          {session.isFile && session.changed && !this.state.overCross ? (<Circle>⬤</Circle>) : (<Icons_1.CrossIcon width={12} height={11} strokeWidth={7} title="Close Tab"/>)}
        </Close>
      </TabItem>);
    };
    return Tab;
}(React.PureComponent));
exports.default = react_redux_1.connect(null, { closeTab: actions_1.closeTab, selectTab: actions_1.selectTab, editName: actions_1.editName })(Tab);
var TabItem = styled_1.styled('div')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  flex: 0 0 auto;\n  display: flex;\n  align-items: center;\n  height: 43px;\n  padding: 10px;\n  padding-top: 9px;\n  margin-right: 10px;\n  font-size: 14px;\n  border-radius: 2px;\n  border-bottom: 2px solid ", ";\n  box-sizing: border-box;\n  cursor: pointer;\n  user-select: none;\n  background: ", ";\n  &:hover {\n    background: ", ";\n    .close {\n      opacity: 1;\n    }\n  }\n"], ["\n  flex: 0 0 auto;\n  display: flex;\n  align-items: center;\n  height: 43px;\n  padding: 10px;\n  padding-top: 9px;\n  margin-right: 10px;\n  font-size: 14px;\n  border-radius: 2px;\n  border-bottom: 2px solid ", ";\n  box-sizing: border-box;\n  cursor: pointer;\n  user-select: none;\n  background: ",
    ";\n  &:hover {\n    background: ", ";\n    .close {\n      opacity: 1;\n    }\n  }\n"])), function (p) { return p.theme.editorColours.navigationBar; }, function (p) {
    return p.active ? p.theme.editorColours.tab : p.theme.editorColours.tabInactive;
}, function (p) { return p.theme.editorColours.tab; });
var OperationName = styled_1.styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  opacity: ", ";\n  background: transparent;\n  color: ", ";\n  font-size: 14px;\n  margin-left: 2px;\n  display: inline;\n  letter-spacing: 0.53px;\n"], ["\n  opacity: ", ";\n  background: transparent;\n  color: ", ";\n  font-size: 14px;\n  margin-left: 2px;\n  display: inline;\n  letter-spacing: 0.53px;\n"])), function (p) { return (p.active ? 1 : 0.5); }, function (p) { return p.theme.editorColours.tabText; });
var OperationNameInput = styled_1.styled(react_input_autosize_1.default)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  input {\n    background: transparent;\n    color: ", ";\n    font-size: 14px;\n    margin-left: 2px;\n    display: inline;\n    letter-spacing: 0.53px;\n  }\n"], ["\n  input {\n    background: transparent;\n    color: ", ";\n    font-size: 14px;\n    margin-left: 2px;\n    display: inline;\n    letter-spacing: 0.53px;\n  }\n"])), function (p) { return p.theme.editorColours.tabText; });
var Icons = styled_1.styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  opacity: ", ";\n"], ["\n  display: flex;\n  align-items: center;\n  opacity: ", ";\n"])), function (p) { return (p.active ? 1 : 0.5); });
