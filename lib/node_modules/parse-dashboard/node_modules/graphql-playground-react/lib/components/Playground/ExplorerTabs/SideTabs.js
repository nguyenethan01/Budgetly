...
var SideTabs = /** @class */function (_super) {
    ...
    function SideTabs(props) {
        ...
        _this.clientX = 0;
        _this.clientY = 0;
        _this.setWidth = function (props) {
            if (props === void 0) {
                props = _this.props;
            }
            if (!_this.activeContentComponent) {
                return;
            }
            ...
            requestAnimationFrame(function () {
                var width = _this.activeContentComponent.getWidth(props);
                _this.props.changeWidthDocs(props.sessionId, Math.min(width, _this.props.maxWidth));
            });
        };
        _this.setActiveContentRef = function (ref) {
            if (ref) {
                _this.activeContentComponent = ref.getWrappedInstance();
            }
        };
        ...
        _this.showDocFromType = function (type) {
            _this.props.setDocsVisible(_this.props.sessionId, true, 0);
            _this.activeContentComponent.showDocFromType(type);
        };
    ...
    SideTabs.prototype.render = function () {
        ...
        return React.createElement(
            Tabs,
            { open: docsOpen, style: docsStyle, ref: this.setRef },
            React.createElement(
                TabsContainer,
                null,
                React.Children.toArray(this.props.children).map(function (child, index) {
                    return React.cloneElement(child, __assign({}, child.props, { key: index, onClick: _this.handleTabClick(index), active: index === activeTabIdx }));
                })
            ),
            React.createElement(TabContentResizer, { onMouseDown: this.handleDocsResizeStart }),
            React.createElement(TabsGradient, { index: activeTabIdx }),
            React.createElement(
                TabContentContainer,
                { onKeyDown: this.handleKeyDown, onMouseMove: this.handleMouseMove, tabIndex: activeTabIdx, color: activeTab && activeTab.props.activeColor, ref: this.setContentContainerRef },
                activeTab && React.cloneElement(activeTab.props.children, __assign({}, activeTab.props, { ref: this.setActiveContentRef, setWidth: this.setWidth }))
            )
        );
    };
    return SideTabs;
...
var TabContentContainer = styled_1.styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: white;\n  display: flex;\n  position: relative;\n  height: 100%;\n  letter-spacing: 0.3px;\n  box-shadow: -1px 1px 6px 0 rgba(0, 0, 0, 0.3);\n  outline: none;\n  &::before {\n    top: 0;\n    bottom: 0;\n    background: ", ";\n    position: absolute;\n    z-index: 3;\n    left: 0px;\n    content: '';\n    width: 6px;\n  }\n"], ["\n  background: white;\n  display: flex;\n  position: relative;\n  height: 100%;\n  letter-spacing: 0.3px;\n  box-shadow: -1px 1px 6px 0 rgba(0, 0, 0, 0.3);\n  outline: none;\n  &::before {\n    top: 0;\n    bottom: 0;\n    background: ", ";\n    position: absolute;\n    z-index: 3;\n    left: 0px;\n    content: '';\n    width: 6px;\n  }\n"])), function (props) {
    return props.theme.colours[props.color] || '#3D5866';
});
