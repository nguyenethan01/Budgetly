...
var SideTabs = /** @class */ (function (_super) {
    ...
    SideTabs.prototype.render = function () {
        ...
        <TabContentContainer onKeyDown={this.handleKeyDown} onMouseMove={this.handleMouseMove} tabIndex={activeTabIdx} color={activeTab && activeTab.props.activeColor} ref={this.setContentContainerRef}>
          {activeTab &&
            React.cloneElement(activeTab.props.children, __assign({}, activeTab.props, { ref: this.setActiveContentRef, setWidth: this.setWidth }))}
        </TabContentContainer>
      </Tabs>);
    };
    return SideTabs;
